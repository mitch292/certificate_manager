...
class CertificateGenerator:
    ...
    def generate_certificate(self):
        ...
        cert = (
            ...
            .not_valid_after(self.expiration_date)
            .add_extension(
    ...
    def to_dict(self):
        return {
            ...
            "certificate_body": self.get_certificate().public_bytes(
...
class CertificateManager:
    ...
    def get_webhooks_to_notify(self):
        if self.webhooks_to_notify is None:
            self.webhooks_to_notify = crud.webhook.get_multi_by_certificate(
                self.db, certificate_id=self.certificate.id
            )
